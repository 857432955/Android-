...
public class HttpsUtil {
    ...
    private static final String[] CERTIFICATES = new String[]{"1_ys.crt","2_ys.crt","root.crt"};
    ...
    public static void initHttpsUrlConnection(Context context) {
        ...
        try {
            sslSocketFactory = getSSLSocketFactory(certificates, context.getAssets().open("Keystore.bks"), "jnhj2018");
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//    }
    ...
    public static InputStream[] getCertificates(Context context, String... fileNames) {
        ...
        try {
            ...
            e.printStackTrace();
            MyLogger.i("cre-error", e.getMessage());
        }
        return null;
    }
    ...
    private static TrustManager[] prepareTrustManager(InputStream... certificates) {
        ...
        try {
            ...
            // TODO: 针对有效期异常导致校验失败的情况，目前没有完美的解决方案
...
//            return getNotValidateTimeTrustManagers((X509TrustManager[]) keyStoreTrustManagers);
    ...
    private static KeyManager[] prepareKeyManager(InputStream bksFile, String password) {
        try {
            ...
            e.printStackTrace();
            MyLogger.i("SSL-error", e.getMessage());
        }
        return null;
    }
